...
const dict = {
  ru: {
    ...
    'buyer.roleBuyer': 'Покупатель', 'buyer.roleSeller': 'Продавец',
    'buyer.buyerSub': 'Войдите или зарегистрируйтесь, чтобы искать запчасти и заказывать.',
    'buyer.sellerSub': 'Войдите как магазин или зарегистрируйте новый, чтобы продавать запчасти.',
    'buyer.phone': 'Телефон', 'buyer.phoneOpt': 'Телефон (необязательно)', 'buyer.contactName': 'Ваше имя (контактное лицо)',
    'buyer.shopName': 'Название магазина', 'buyer.city': 'Город', 'buyer.plan': 'Тариф', 'buyer.noShopName': 'Укажите название магазина.',
    'buyer.profile': 'Профиль', 'buyer.save': 'Сохранить', 'buyer.saved': 'Сохранено',
  ...
  tg: {
    ...
    'buyer.roleBuyer': 'Харидор', 'buyer.roleSeller': 'Фурӯшанда',
    'buyer.buyerSub': 'Барои ҷустуҷӯ ва фармоиши қисмҳо ворид шавед ё сабти ном кунед.',
    'buyer.sellerSub': 'Ҳамчун мағоза ворид шавед ё мағозаи нав сабт кунед, то қисмҳоро фурӯшед.',
    'buyer.phone': 'Телефон', 'buyer.phoneOpt': 'Телефон (ихтиёрӣ)', 'buyer.contactName': 'Номи шумо (шахси алоқа)',
    'buyer.shopName': 'Номи мағоза', 'buyer.city': 'Шаҳр', 'buyer.plan': 'Таъриф', 'buyer.noShopName': 'Номи мағозаро нависед.',
    'buyer.profile': 'Профил', 'buyer.save': 'Нигоҳ доштан', 'buyer.saved': 'Нигоҳ дошта шуд',
  ...
  en: {
    ...
    'buyer.roleBuyer': 'Buyer', 'buyer.roleSeller': 'Seller',
    'buyer.buyerSub': 'Sign in or sign up to search for parts and place orders.',
    'buyer.sellerSub': 'Sign in as a shop or register a new one to sell parts.',
    'buyer.phone': 'Phone', 'buyer.phoneOpt': 'Phone (optional)', 'buyer.contactName': 'Your name (contact person)',
    'buyer.shopName': 'Shop name', 'buyer.city': 'City', 'buyer.plan': 'Plan', 'buyer.noShopName': 'Enter the shop name.',
    'buyer.profile': 'Profile', 'buyer.save': 'Save', 'buyer.saved': 'Saved',
